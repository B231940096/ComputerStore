...
const categories = [
  { id: "iPhone", label: "iPhone", icon: <LaptopMinimal className="w-5 h-5" /> }, 
  { id: "tablet", label: "Таблет", icon: <LaptopMinimalCheck className="w-5 h-5" /> },
  { id: "smartwatch", label: "Ухаалаг цаг", icon: <BriefcaseBusiness className="w-5 h-5" /> },
  { id: "accessories", label: "Дагалдах хэрэгсэл", icon: <Menu className="w-5 h-5" /> },
  { id: "earbuds", label: "Гар утасны чихэвч / Earbuds", icon: <LaptopMinimalCheck className="w-5 h-5" /> },
  { id: "cables", label: "Гар утасны кабел / Адаптер", icon: <BriefcaseBusiness className="w-5 h-5" /> },
]
