...
export default function PreBuiltPC({ products }: PreBuiltPCProps) {
    return (
                    ...
                    >
                        ...
                        <CardContent className="p-4 flex flex-col justify-between">
                            ...
                            <div className="flex gap-2 mt-2 flex-wrap">
                                ...
                                {product.is_free_delivery && <Badge variant="outline">Хүргэлт үнэгүй</Badge>}
                            </div>
                        </CardContent>
